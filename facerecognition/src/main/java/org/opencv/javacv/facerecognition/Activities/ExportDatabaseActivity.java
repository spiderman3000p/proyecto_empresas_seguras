...
public class ExportDatabaseActivity extends AppCompatActivity {
    ...
    private void iniciarExportacion(Uri uri) {
        try {
            ...
            if (pfd != null) {
                ...
                case NOT_SELECTED_TABLES_ERROR:
                    ...
                    break;
                case RESULT_OK:
                    Log.i("app", "exportation data created succesfull!");
                    try {
    ...
    private int exportDatabaseToJsonFile(List<String> tables,String where_clause){
        ...
        try {
            ...
            jsonTables = tablesToJson(tables, where_clause);
            Log.i("app", "2. JSON tables array values: " + jsonTables.toString());
            ...
            Log.i("app", "2. JSON main object values: " + jsonObjectMain.toString());
    ...
    public JSONArray tablesToJson(List<String> nombres_tablas,String where_clause){ // el retorno es entero porque retornara un codigo de status...identificados en CustomHelper
    ...
    private boolean fillSelectedTables(){
        ...
        selectedTables = new ArrayList<>(); // Esto es asi, porque un modulo puede involucrar varias tablas
    ...
    private void createFile(String mimeType, String fileName) {
        Intent intent = null;
        Log.i("app", "Attempting create file");
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.KITKAT) {
            Log.i("app", "android version is > than kitkat");
    ...
    public void onActivityResult(int requestCode, int resultCode,
        ...
        if (requestCode == WRITE_REQUEST_CODE && resultCode == RESULT_OK) {
            Log.i("app", "Directorio seleccionado");
            ...
            Log.i("app", "Directorio no seleccionado");
        }
    }
