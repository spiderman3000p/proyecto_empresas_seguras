...
import org.opencv.javacv.facerecognition.Adapters.MyListAdapter3;
...
public class ControlAzucarActivity extends AppCompatActivity {

    ContentValues userData;
    MyListAdapter3 rAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(R.string.title_activity_control_azucar);
    ...
    public void inicializarAdapter(){
        rList = new ArrayList<>();
        obtenerAzucars();
        rAdapter = new MyListAdapter3(this,rList);
        if(searchText.getText().length() > 0)
            rAdapter.getFilter().filter(searchText.getText());
        rv.setAdapter(rAdapter);
    }

    public void obtenerAzucars(){
        DatabaseAdmin db = new DatabaseAdmin(this);
        rList.addAll(db.obtenerRegistrosAzucars());
        Log.i("app","rList: "+rList);
        db.close();
    }

    private void consultaAzucars(DateTime desde, DateTime hasta, String texto) throws IOException {

        if (rList.isEmpty()) {
            Log.i("app", "Lista de controles de azucar esta vacia!");
            return;
        }else{
            Log.i("app", "Lista de controles de azucar esta llena con " + rList.size() + " elementos");
        }
    ...
    public boolean onOptionsItemSelected(final MenuItem item) {
        ...
        if (id == R.id.addRadio_action) {
            Intent intent = new Intent(ControlAzucarActivity.this, ControlAzucarNuevo.class);
            ...
            try {
                ...
                txtDesdeFindRadio.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        CustomHelper.showDialogDate(ControlAzucarActivity.this,dfDesde,dtDesde,txtDesdeFindRadio);
                    }
                });
                ...
                txtHastaFindRadio.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        CustomHelper.showDialogDate(ControlAzucarActivity.this,dfHasta,dtHasta,txtHastaFindRadio);
                    }
                });

                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ControlAzucarActivity.this);
                ...
                Log.i("Debug", "Error popup buscar Azucars" + e.getMessage());
                e.printStackTrace();
            }
        }
        if(id == R.id.home){
